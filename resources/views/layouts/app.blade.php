...
<header class="bg-yellow-500 text-gray-600 body-font">
  ...
  <path d="M15 8a3 3 0 10-2.977-2.63l-4.94 2.47a3 3 0 100 4.319l4.94 2.47a3 3 0 10.895-1.789l-4.94-2.47a3.027 3.027 0 000-.74l4.94-2.47C13.456 7.68 14.19 8 15 8z" />
    ...
    <nav class="md:ml-auto flex flex-wrap items-center text-base justify-center">
      ...
      <a class="mr-5 hover:text-gray-900">Categorie</a>
      <a class="mr-5 hover:text-gray-900">F.A.Q</a>
      <a class="mr-5 hover:text-gray-900">Inscription</a>
    </nav>
...
<div class="container px-5 py-5 mx-auto">
  ...
  <!-- <div class="bg-yellow-500"> -->
    <div class="bg-yellow-500 container px-5 py-6 mx-auto flex items-center sm:flex-row flex-col">
  ...
  <path d="M15 8a3 3 0 10-2.977-2.63l-4.94 2.47a3 3 0 100 4.319l4.94 2.47a3 3 0 10.895-1.789l-4.94-2.47a3.027 3.027 0 000-.74l4.94-2.47C13.456 7.68 14.19 8 15 8z" />
      ...
      <p class="text-sm text-gray-500 sm:ml-6 sm:mt-0 mt-4">© 2021 Rentools 
